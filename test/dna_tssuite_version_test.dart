...
void main() {
  group('dna_tssuite_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/dna_tssuite_version.dart');
